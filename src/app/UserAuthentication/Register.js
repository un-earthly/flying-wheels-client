...
export default function Register() {
    ...
    const onSubmit = async (data) => {
        axios.post(LOGIN_URL, { email: data.email })
        ...
        <div className='bg-white md:w-1/2 mx-auto rounded px-8 pb-8 mb-4 space-y-7 mt-16'>
            <form className='space-y-10' onSubmit={handleSubmit(onSubmit)}>
                ...
                <label className="block text-gray-700 text-sm font-bold mb-2 space-y-3" htmlFor="img">
                    <span>Image</span>
                    <input className="appearance-none border-b focus:border-success outline-none duration-300 w-full py-2 md:text-xl px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="img" type="text" placeholder="img" {...register("img")} />
