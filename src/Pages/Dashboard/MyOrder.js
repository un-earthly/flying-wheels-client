...
export default function MyOrder() {
  const { data: orders, isLoading, refetch } = useQuery(["orders"], () => axiosPrivate.get('https://flying-wheels.onrender.com/myorders').then(res => res.data))
  ...
  const deleteOrder = () => {
    axiosPrivate.delete('https://flying-wheels.onrender.com/order' + id).then(res => {
