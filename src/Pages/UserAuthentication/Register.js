...
export default function Register() {
    ...
    const onSubmit = async (data) => {
        axios.post('https://flying-wheels.onrender.com/login', { email: data.email })
    ...
    if (user) {
        if (user.user.displayName) {
            axios.put('https://flying-wheels.onrender.com/user', { email: user.user.email, name: user.user.displayName, photoURL: user.user.photoURL })
        }
